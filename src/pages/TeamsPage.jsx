  ...
  return (
    <>
      <section className="page-title teams-title">
        ...
        <h2>All Teams</h2>
        <p>
          Browse every QMJHL team. Team pages can later connect to live rosters,
          schedules, player stats, news, and projected lineups.
        </p>
      </section>
          ...
          {teams.map((team) => (
            ...
            >
              ...
              <div className="team-logo-area">
                {team.logo ? (
                  <img src={team.logo} alt={`${team.fullName} logo`} />
                ) : (
